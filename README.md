...
<br><br>
**-Valeria Cadena, Translation Contributor**<br>
_Valeria Cadena Galván is a fifth-semester student at the Library Science College of the National Autonomous University of Mexico (UNAM). She is passionate about archivology, viewing archives as living ecosystems where collective memory is built. She is fascinated by the ethical responsibility of preserving historical records for future generations. Valeria is equally captivated by how people interact with information, and she deeply loves library science for its vital role in building an informed, democratic society. She firmly believes that librarians and archivists are essential agents of social justice, bridging knowledge gaps and guaranteeing access to all. Currently, she serves as a class assistant to Professor Jorge Gómez Briseño, an experience that enriches her academic journey and reinforces her commitment to the profession._
<br><br>
...
<br><br>
**Leonardo Emiliano Flores Bocanegra, Translation Contributor**<br>
_I am a 21-year-old undergraduate student pursuing a Bachelor's Degree in Library and Information Science at the Faculty of Philosophy and Letters of the National Autonomous University of Mexico (UNAM). Currently, I am completing my social service at the Central Library of UNAM in the Continuing Education Department. In this role, I support several faculty members in the development and coordination of academic activities, contributing to educational and institutional projects.  Also, I support Dr. Jorge Briseño in pedagogical activities and academic initiatives. I possess an intermediate level of English comprehension, which enables me to consult academic literature and access professional resources in English. My academic interests are centered on research, particularly topics related to the relationship between libraries and their social environment, the role of information services in community development, and the impact of libraries on education and society. I am committed to continuous learning, academic collaboration, and the advancement of library and information services that contribute to social development and knowledge dissemination._
<br><br>
**-Cerberus Forbes [lycanlibrarian](https://github.com/lycanlibrarian), Transformation Contributor**<br>
_Cerberus (xe/xem/xyr, it/it/its) is a graduate student in the Master of Library and Information Science program at the University of Washington who is passionate about supporting digital systems for open data architecture. Xe currently interns at the Pacific Northwest Railroad Archive and it aspires to contribute to the field of digital archival with a focus on how the metadata of digital-first materials are represented and accessed._
<br><br>
...
_Crystal Yragui (she/her/hers) is an Assistant Teaching Professor at the University of Washington iSchool. Crystal's work focuses on linked data, identity management, cataloging in MARC and non-MARC formats, and MARС and non-MARC metadata management. She serves as a co-chair of the PCC Identity Management Advisory Committee (IMAC). She earned an M.L.I.S. from the University of Washington._ <br><br>
